...
export const TOOL_LABELS: Record<OperatorToolName, { start: string; done: string }> = {
  ...
  list_templates: { start: 'Sto leggendo i modelli…', done: 'Modelli caricati' },
  list_demos: { start: 'Sto leggendo le anteprime…', done: 'Anteprime caricate' },
  inspect_demo: { start: 'Sto guardando l’anteprima…', done: 'Anteprima pronta' },
  inspect_template: { start: 'Sto guardando il modello…', done: 'Modello pronto' },
  list_calendar_events: { start: 'Sto leggendo il calendario…', done: 'Appuntamenti caricati' },
  list_available_slots: { start: 'Sto leggendo gli orari liberi…', done: 'Orari liberi caricati' },
