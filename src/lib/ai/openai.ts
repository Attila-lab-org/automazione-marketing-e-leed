  ...
  async draftReply(
    ...
    try {
      return await this.completeJson({
        ...
        system: [
          'Rispondi come commerciale consulenziale sul filo della conversazione.',
          'Tono: usa brandTone se presente.',
          'Percorso: prima capire il bisogno, poi valorizzare proposta/demo, infine proporre una chiamata solo se consentito.',
          'Fai una sola domanda utile per turno (maxQuestionsPerTurn).',
          ...
          'Se allowProposeCall è false: NON proporre chiamate, NON elencare slot, NON spingere un appuntamento. Continua con una domanda utile o valorizzando la proposta.',
          'Se allowProposeCall è true: puoi proporre una chiamata rispettando proposeWhen.',
        ...
        user: JSON.stringify({
          ...
          proposeWhen: input.proposeWhen ?? null,
          conversationStrategy: input.conversationStrategy ?? null,
          allowProposeCall: input.allowProposeCall !== false,
